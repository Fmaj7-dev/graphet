emcc -I./src/ -I./external/glm  src/app/main.cpp -c -o build/main.o &
...
emcc -I./src -I./external/glm src/ui/windowmanager.cpp -c -o build/windowmanager.o &
emcc -I./src -I./external/glm src/graph/graph.cpp -c -o build/graph.o &
...
emcc -I./external/glm build/main.o build/segmentsystem.o build/particlesystem.o build/background.o build/renderable.o build/rendermanager.o build/camera.o build/glwrapper.o build/windowmanager.o build/graph.o build/forceatlaslayout.o build/testlayout.o build/symmetric_matrix.o -o build/app.html
