...
emcc build/main.o build/segmentsystem.o build/particlesystem.o build/background.o build/renderable.o build/rendermanager.o build/windowmanager.o build/graph.o -o build/app.html
